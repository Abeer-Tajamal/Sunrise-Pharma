...
const Testimonials = () => {
  ...
  const reviewData3 = {
    ...
    Title: "John Brokelyn",
    ratingValue: 5,
    content: "My grandmother is a patron of Sunrise Pharmacy, and she's delighted with her experience. According to her, she has saved a substantial amount on her prescriptions since she began using their services. The pharmacist is exceptionally kind and takes the time to build a personal connection with his clients."
  };
