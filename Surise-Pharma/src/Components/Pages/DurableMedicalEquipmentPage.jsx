...
const DurableMedicalEquipmentPage = () => {
    DynamicPageTitle("Durable Medical Equipment - Sunrise Pharmacy - Your Local Orange Pharmacy");

    const image = "./Assets/Services/Medical Equipment.jpg";
    const description = "Our pharmacy offers an extensive variety of medical equipment and supplies.";
    const description2 = "Our medical equipment may include, but is not limited to:";
    const description4 = "If you are in need of any medical equipment or supplies or just have a question, ask a staff member today. Our staff will make it as easy as possible to get the equipment you need, including the billing. We will bill Medicare and most insurance companies."
    const arrayList = [
