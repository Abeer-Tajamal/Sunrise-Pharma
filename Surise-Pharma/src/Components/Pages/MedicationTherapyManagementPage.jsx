...
const MedicationTherapyManagementPage = () => {
    DynamicPageTitle("Medication Therapy Management - Sunrise Pharmacy - Your Local Orange Pharmacy");

    const image = "./Assets/Services/Medication Management/Medication Management.jpg";
    const description = "Medication therapy management, otherwise known as MTM, is a term used for a program to help you manage your medications and health conditions.";
    ...
    const description5 = "Make an appointment today for a medication therapy management session with one of our pharmacists.";
    const arrayList = [
    ...
    return (
        <>
            ...
            <MediaRight image={image} description={description} array={arrayList} description4={description4} description5={description5} />
            <Footer />
        </>
    );
};
