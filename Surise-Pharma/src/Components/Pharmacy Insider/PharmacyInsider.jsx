    ...
    <>
      <div className="insider-section">
        <div>
          ...
          <p className="pharmacy-insider-content">
            Our devoted team of medical experts is dedicated to providing secure
            and efficient vaccinations in a convenient and pleasant setting.
          </p>
          <br />
